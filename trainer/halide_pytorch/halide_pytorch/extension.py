    ...
    def _get_gen_cxxflags(self, flags, hl_distrib):
        if flags is None:
            flags =["-O3", "-std=c++17",
                    ...
                    "-I", os.path.join(hl_distrib, "share", "Halide", "tools"),
    ...
    def _get_gen_deps(self, flags, hl_distrib):
        ...
        if flags is None:
            flags = [os.path.join(hl_distrib, "bin", "libHalide"+ext),
                     ...
                     os.path.join(hl_distrib, "share", "Halide", "tools", "GenGen.cpp")]
            ...
            if isinstance(ext, HalidePyTorchExtension):
                ...
                for g in generators:
                    ...
                    for gen in generators[g]:
                        ...
                        env["DYLD_LIBRARY_PATH"] = "/home/yanxiao/Halide-12.0.0-x86-64-linux/bin"
                        if "LD_LIBRARY_PATH" in env:
                            print("--printing envs--")
                            print(env["LD_LIBRARY_PATH"])
                            print("--ending envs--")
                            env["LD_LIBRARY_PATH"] = "/home/yanxiao/Halide-12.0.0-x86-64-linux/bin:" + env["LD_LIBRARY_PATH"]
                        else:
                            env["LD_LIBRARY_PATH"] = "/home/yanxiao/Halide-12.0.0-x86-64-linux/bin"
